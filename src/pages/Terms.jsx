    ...
    <div>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Mphasis, 4th Floor, Fusion Square, Sector
            126, Noida, Uttar Pradesh 201313.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Interview Schedular, accessible
            from{" "}
            <a
              href="https://ms-teams-schedular.herokuapp.com/"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://ms-teams-schedular.herokuapp.com/
            </a>
          </p>
        </li>
        <li>
      ...
      <ul>
        <li>
          ...
          <a
            href="https://ms-teams-schedular.herokuapp.com/contact"
            rel="external nofollow noopener"
            target="_blank"
          >
            https://ms-teams-schedular.herokuapp.com/contact
          </a>
        </li>
      </ul>
    </div>
